...
## v8.8 — модели мебели и монтажная панель щита

Два дивана, кресло и 11 стульев заменены локальными glTF-моделями Poly Haven с текстурами материалов (CC0). Дубовый шпон, более тонкие фаски и скорректированный дневной свет. Выберите объект → «Рассмотреть вблизи».

Щит получил светлую монтажную панель, каналы, маркировку и функциональные подписи рядов по мотивам подхода Comfort-Life. Открыть: «Щит» → «Монтаж щита · крупный план». Контактная карта и редактирование DIN-реек сохранены. Подробности, источники и границы проверки: [QUALITY-v8.8.md](QUALITY-v8.8.md).
